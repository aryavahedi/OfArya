...
date: 2024-02-01
img: assets/img/Projects/TobaccoPipe/Cover.jpg
importance: 1
category: work
...
1. Change its appearance. This pipe should look different.
2. Combine metal with wood.
3. Use my jewelry-making skills on wood.
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Projects/TobaccoPipe/6.jpg" title="Restoration process" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Projects/TobaccoPipe/1.jpg" title="Restoration process" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Projects/TobaccoPipe/2.jpg" title="Restoration process" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Projects/TobaccoPipe/4.jpg" title="Restoration process" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Projects/TobaccoPipe/3.jpg" title="Restoration process" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Projects/TobaccoPipe/5.jpg" title="Restoration process" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Projects/TobaccoPipe/10.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
1. You can make something truly luxurious out of something very cheap.
2. Wood will always amaze you, even when it is low quality.
3. The combination of wood and metal can be great. It feels natural and real.
